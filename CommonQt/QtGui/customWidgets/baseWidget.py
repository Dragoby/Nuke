...
class BaseWidget(QtGui.QWidget):
    ...
    def initialize(self):
        """
        This is used to initialize the widget (self) by calling all the individual initialization methods
        """
    ...
    def initializeInterface(self):
        """
        This is used to add all the widgets to the main layout and set all interface items. This must be overridden
        """
